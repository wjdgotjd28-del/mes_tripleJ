...
import { Box, CssBaseline, Drawer, IconButton, List, ListItem, ListItemButton, ListItemIcon, ListItemText, Toolbar, AppBar, Typography, Divider } from "@mui/material";
import { Menu as MenuIcon, Layers} from "@mui/icons-material";

// 각 카테고리별 ViewPage/ RegisterPage import
import OrderViewPage from "../../masterData/items/pages/OrderViewPage";
import RawViewPage from "../../masterData/items/pages/RawViewPage";
// 다른 카테고리도 필요하면 import
...
//   const currentPath = `${activeMain} > ${activeSub} > ${activeThird}`;
  ...
  const pageMap: Record<string, React.ReactNode> = {
    ...
    // "기준 정보 관리 > 라우팅 관리": <InboundViewPage />,
    // "기준 정보 관리 > 업체 관리": <InboundRegisterPage />,
    // 다른 메뉴도 계속 추가
  };
