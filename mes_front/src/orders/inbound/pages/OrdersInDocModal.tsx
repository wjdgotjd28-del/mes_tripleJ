      ...
      <DialogContent>
        ...
        >
          ...
          <table>
            <tbody>
              <tr>
                <td style={titleCellStyle}>거래처</td>
                <td>{orderItem.company_name}</td>
                <td style={titleCellStyle}>LOT 번호</td>
                <td>{lotNo ?? "-"}</td>
              </tr>
              <tr>
                <td style={titleCellStyle}>품목명</td>
                <td>{orderItem.item_name}</td>
                <td style={titleCellStyle}>품목번호</td>
                <td>{orderItem.item_code}</td>
              </tr>
              <tr>
                <td style={titleCellStyle}>분류</td>
                <td>{CATEGORY_LABELS[orderItem.category] || orderItem.category}</td>
                <td style={titleCellStyle}>도장방식</td>
                <td>{PAINT_LABELS[orderItem.paint_type] || orderItem.paint_type}</td>
              </tr>
              <tr>
                <td style={titleCellStyle}>색상</td>
                <td>{orderItem.color ?? "-"}</td>
                <td style={titleCellStyle}>수량</td>
                <td>{qty}</td>
              </tr>
              <tr>
                <td style={titleCellStyle}>비고</td>
